...
newcs = [-2.12946985e+03, -2.14752915e+03, -2.69507279e+01,  1.51878244e+00, 4.79717339e+01, -2.30043513e+00,
         -1.12499455e+00, -5.86749641e-01, -1.43627457e+03, -1.00000000e+00]
...
plt.figure(figsize=(16,8))
plt.plot(zre2 - z, '.', c='xkcd:rose', label='Fitted points and measured points residuals')
...
plt.axhline(RMSE(z, zre2),ls='--', c='xkcd:rose', linewidth=4, xmin=0.04, xmax=0.96, label=r'RMSE $= \lambda /${:.2f}'.format(0.002/RMSE(z, zre2)))
plt.legend(loc='upper left')
plt.xlabel('z data point [unitless]')
plt.ylabel(r'$\Delta z$ [m]')
#plt.savefig('/home/james/OneDrive/Thesisv5/Figures/figsc3/300kmeasuredandmeaseqn.png', facecolor='white')
...
plt.scatter(y,x, c= zre2 - z, cmap='PiYG', norm=divnorm)
plt.colorbar(label=r'$\Delta z$ [m]')
plt.xlabel('M1 RF x (m)')
plt.ylabel('M1 RF y (m)')
#plt.savefig('/home/james/OneDrive/Thesisv5/Figures/figsc3/300kscattermeastest.png', facecolor='white')
```
